...
export const WindowFrame = ({ title, onClose, children }: PropsWithChildren<WindowFrameProps>) => {
  ...
  const containerClass = isMaximized
    ? "fixed left-2 right-2 top-2 bottom-16 glass elevated rounded-lg border overflow-hidden animate-enter"
    : "absolute glass elevated rounded-lg border overflow-hidden animate-enter";
